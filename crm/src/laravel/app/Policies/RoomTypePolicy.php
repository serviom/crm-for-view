...
class RoomTypePolicy
{
    ...
    {
        return $user->hasPermissionTo('room_type.viewAny');
    }
    ...
    {
        return $user->hasPermissionTo('room_type.view');
    }
    ...
    {
        return $user->hasPermissionTo('room_type.create');
    }
    ...
    {
        return $user->hasPermissionTo('room_type.update');
    }
    ...
    {
        return $user->hasPermissionTo('room_type.delete');
    }
