...
class LandPurposeTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $data = [
            ...
            "02 Землі житлової забудови (землі, які використовуються для розміщення житлової забудови",
            ...
            "15.10 Для розміщення та постійної діяльності Національної поліції України, її територіальних органів, підприємств, установ та організацій, що належать до сфери управління Національної поліці",
            "16.00 Землі запасу",
        ...
        foreach ($data as $order => $title) {
            $item = LandPurpose::where('title', $title)->first();
            if(!$item) {
                LandPurpose::create([
                    'title' => $title,
                    'order' => $order,
...
//        LandPurpose::factory()->count(30)->create();
    }
}
